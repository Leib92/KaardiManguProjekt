...
namespace KaardiManguProject.Migrations
{
    ...
    [Migration("20260603080353_filterdata")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KaardiManguProject.Core.Domain.Actors", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("KaardiManguProject.Core.Domain.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("FavoriteListIDs")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("KaardiManguProject.Core.Domain.FavoriteList", b =>
                {
                    b.Property<Guid>("FavoriteListID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("KaardiManguProject.Core.Domain.FileToApi", b =>
                {
            ...
            modelBuilder.Entity("KaardiManguProject.Core.Domain.FileToDatabase", b =>
                {
                    b.Property<Guid>("ImageID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("KaardiManguProject.Core.Domain.Movie", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("KaardiManguProject.Core.Domain.UserComment", b =>
                {
            ...
            modelBuilder.Entity("KaardiManguProject.KaardiManguProject.Core.Domain.ChatLog", b =>
                {
            ...
            modelBuilder.Entity("KaardiManguProject.KaardiManguProject.Core.Domain.Filter", b =>
                {
            ...
            modelBuilder.Entity("KaardiManguProject.Core.Domain.Actors", b =>
                {
                    b.HasOne("KaardiManguProject.Core.Domain.FavoriteList", null)
            ...
            modelBuilder.Entity("KaardiManguProject.Core.Domain.UserComment", b =>
                {
                    b.HasOne("KaardiManguProject.Core.Domain.Movie", null)
                        .WithMany("Reviews")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("KaardiManguProject.Core.Domain.ApplicationUser", null)
                        .WithMany()
